    ...
    <section className="bg-background py-16 sm:py-20" aria-labelledby="curriculum-heading">
      <div className="mx-auto max-w-4xl px-4 sm:px-6">
        <SectionHeading
          ...
          description={<>ツールの操作研修では、ありません。中小企業診断士のシステム思考で御社の業務を分解し、「何を・どの順でAIに任せるか」を見極め、自社の実務でその場で動かすところまで。<br /><br /><span className="text-xs text-muted-foreground">※以下はカリキュラムのサンプルです。実際は受講前に約1時間のヒアリングを行い、御社の課題に合わせて内容を設計します。</span></>}
        />
